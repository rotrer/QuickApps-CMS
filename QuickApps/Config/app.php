...
$settings = json_decode(file_get_contents(ROOT . '/Config/database.json'));

$config['Datasources']['default']['driver'] = 'Cake\Database\Driver\\' . $settings->driver;
$config['Datasources']['default']['persistent'] = $settings->persistent;
$config['Datasources']['default']['host'] = $settings->host;
$config['Datasources']['default']['login'] = $settings->login;
$config['Datasources']['default']['password'] = $settings->password;
$config['Datasources']['default']['database'] = $settings->database;
$config['Datasources']['default']['prefix'] = $settings->prefix;
$config['Datasources']['default']['encoding'] = $settings->encoding;